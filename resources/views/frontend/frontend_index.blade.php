      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="{{ asset($item->image) }}" alt="Men slide img" />
              </div>
              <div class="seq-title">
               <span data-seq>Save Up to {{ $item->discount }}% Off</span>                
                <h2 data-seq>{{ $item->collection_name }}</h2>                
                <p data-seq>{{ $item->short_describtion }}</p>
                <a data-seq href="{{ $item->btn_link }}" class="aa-shop-now-btn aa-secondary-btn">{{ $item->btn_txt }}</a>
              </div>
            </li>   
            @endforeach    
          </ul>
              ...
              <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="{{ asset('frontend') }}/img/lehenga.jpg" alt="img">                    
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                    ...
                    <div class="aa-single-promo-right">
                        <div class="aa-promo-banner">                      
                          <img src="{{ asset($category->category_image) }}" style="height: 400px; width: 350px;" alt="img">                      
                          <div class="aa-prom-content">
        ...
        <div class="col-md-12">
          <div class="aa-client-brand-area">
            <ul class="aa-client-brand-slider">
                ...
                <li><a href="#"><img src="{{ asset($brand->brand_image) }}" alt="wordPress img"></a></li>
                @endforeach
            </ul>
          </div>
        </div>
